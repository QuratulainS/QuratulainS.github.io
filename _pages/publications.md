...
Qurat-ul-ain Shaheen, Alice Toniolo, and Juliana Bowles. **Dialogue Games for Explaining Medication Choices**. *RuleML+RR 2020: International Joint Conference on Rules and Reasoning. Lecture Notes in Computer Science*,
12173 LNCS, 97–111. (2020, June). Springer, Cham. DOI: [link](https://doi.org/10.1007/978-3-030-57977-7_7).
...
Qurat-ul-ain Shaheen, Alice Toniolo, and Juliana Bowles. **Argumentation-Based Explanations of Multimorbidity Treatment Plans**. *PRIMA 2020: Principles and Practice of Multi-Agent Systems. Lecture Notes in Computer Science*, 
12568 LNAI, 394–402. (2021, November). Springer, Cham. DOI: [link](https://doi.org/10.1007/978-3-030-69322-0_29)
...
Martijn Demollin, Qurat-ul-ain Shaheen, Katarzyna Budzynska,and Carles Sierra. **Argumentation Theoretical Frameworks for Explainable Artificial Intelligence**.
*2nd Workshop on Interactive Natural Language Technology for Explainable Artificial Intelligence*, 44–49. (2020, November). ACM. URL: [link](https://aclanthology.org/2020.nl4xai-1.10/)
